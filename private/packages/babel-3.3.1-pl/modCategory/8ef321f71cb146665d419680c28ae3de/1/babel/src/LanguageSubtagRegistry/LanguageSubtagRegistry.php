...
namespace mikrobi\Babel\LanguageSubtagRegistry;
...
class LanguageSubtagRegistry
{
    ...
    public function languagesArray()
    {
        ...
        array_shift($registries); // Remove file date
        $languagesArray = [];
     ...
     *
     * @param array $assoc ('key' => 'value') : search the parent key with the value
     * @param string $returnKey get the value from this key. If null/ not set, it will return the previous value
