...
$_lang['setting_redactor.plugin_replacer'] = 'Replace Plugin';
$_lang['setting_redactor.plugin_replacer_desc'] = 'When enabled use CTRL+F to trigger a simple Find and Replace tool.';

$_lang['setting_redactor.plugin_replacer_button'] = 'Replace Plugin Button';
$_lang['setting_redactor.plugin_replacer_button_desc'] = 'When enabled, the replacer plugin is also available as a button in the toolbar and not just as the CTRL+F shortcut.';
