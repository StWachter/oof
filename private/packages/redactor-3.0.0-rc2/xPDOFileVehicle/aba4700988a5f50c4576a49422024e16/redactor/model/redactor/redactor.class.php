...
final class Redactor
{
    ...
    public function __construct(modX $modx,array $config = array()) {
        $this->modx =& $modx;
        $this->version = new VersionObject(3, 0, 0, 'rc2');
    ...
    public function initialize() {
        if (!$this->assetsLoaded) {
            ...
            $this->modx->controller->addCss($this->config['assetsUrl'] . 'vendor/codemirror/codemirror.css' . $version);
...
HTML;
     ...
     */
    public function getWorkingContext(): ?modContext
    {
        return $this->wctx;
    }
}
