...
class Redactor {
    ...
    */
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->version = new VersionObject(2, 3, 4, 'pl');
...
Ext.onReady(function() {
    ...
    public function initialize() {
        if (!$this->assetsLoaded) {
            ...
            $this->modx->controller->addCSS($this->config['assetsUrl'].'redactor-2.3.4.min.css');
            ...
            $this->modx->controller->addJavascript($this->config['assetsUrl'].'redactor-2.3.4.min.js');
